...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.editTipoAtributo = QtWidgets.QLineEdit(self.groupBoxAtributos)
        self.editTipoAtributo.setGeometry(QtCore.QRect(50, 85, 171, 20))
        self.editTipoAtributo.setObjectName("editTipoAtributo")
        ...
        self.labelMediana_2.setGeometry(QtCore.QRect(120, 70, 61, 20))
        self.labelMediana_2.setObjectName("labelMediana_2")
        self.pushButton = QtWidgets.QPushButton(self.groupBoxAtributos)
        self.pushButton.setGeometry(QtCore.QRect(50, 170, 171, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Eliminar atributo"))
