...
# Form implementation generated from reading ui file 'ventana_fuera_dominio_ui.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Valores fuera de dominio"))
        self.label.setText(_translate("Form", "Instancias fuera de dominio"))
        self.labelDescripcion.setText(_translate("Form", "Identificadores de las instancias que tiene valores fuera de dominio para el atributo "))
